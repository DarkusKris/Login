...
echo('<a href="grupos_lista.php"><input type="button" class="btn btn-warning" name="materia['.$value["id_materia"].']" value=" '.$value["nombre_materia"].' " style="width:35%; height:33px; font-size: 16px"></a><br>');
