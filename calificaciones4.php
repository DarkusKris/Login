...
$query = 'SELECT u.id_alumno, u.nombre_alumno FROM usuarios u 
          ...
          INNER JOIN materia_docente mD ON mD.clave_materia LIKE mA.clave_materia4
          WHERE mD.clave_materia = "ISD-1605"';
...
?>
    <div><br><br><center><input type="submit" class="btn btn-primary" value="Ingresar datos" style='width:35%; height:30px;'OnClick="location.href='insertar_calificaciones_4.php'">
    </center>
    </div><br><br>
