...
<!-- -->
<form method="post" action="insertar_calificaciones_2.php"><br>
  <?php
...
$query = 'SELECT u.id_alumno, u.nombre_alumno FROM usuarios u 
          ...
          INNER JOIN materia_docente mD ON mD.clave_materia LIKE mA.clave_materia2
          WHERE mD.clave_materia = "ISD-1604"';
